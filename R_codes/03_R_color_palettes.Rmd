...
If you use ```scale_fill_brewer(palette = "Accent")``` you can specify the Accent palette from RcolorBrewer.  
...
![picture](https://upload.wikimedia.org/wikipedia/commons/4/48/Red_Spider_Lily----Lycoris_radiata.jpg)        
