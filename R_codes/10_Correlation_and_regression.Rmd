...
**Note that the p value does not indicate how strong the correlation is.** This is very important, and so many people confuse p value with the strength of the correlation. \
...
*Note*: this is not the mathematically "correct" method. This method finds the best fit for 1/V, instead of V itself. The more correct approach is to use a generalized linear model, which will not be covered in this introductory lesson.
