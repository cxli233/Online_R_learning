...
If you have no experiences, or limited experiences in R,
...
A difference between R and many other coding languages (e.g., C) is that in R you learn more about how to use other packages, and less about coding stuff yourself.
