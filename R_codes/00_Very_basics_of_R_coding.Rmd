...
You can view all the sections at the file outline. The shortcut is Ctrl+Shift+O for PC and Cmd+Shift+P for Mac. 
You'll see that section titles will show up at the left.
...
If you look at the environment at the upper left, you should see 'a' shows up as a saved item. 
...
You see how the parentheses of log2() and sqrt() is nested.
