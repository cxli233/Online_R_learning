...
However, for example, if the same animal is measured twice, then it will violate the assumption of independence.
...
Compare the bill width across the three species and find out which one has the widest bill. 
