...
. As more PCR cycle occurred, more dsDNA was made, and more flurorescence.\
Thus you can use the fluorescence to track the concentration of PCR product
s.
...
The reverse function for logistic is logi
t.
...
Ecologists call that "the population has reached the carrying capacity of its habita
t".
...
Molecular biologist call that "the PCR has reached saturatio
n".
...
finding these observed parameters is beyond chanc
e.
...
There are other options to estimate R\^2 and don't worry about the
m.
...
The predicted total number of cases will be about twice the amount of cases at the inflection poin
t.
...
These data were download on 6/19/202
0
...
We have \~120 days of data when this was download, so let's take the first 60 days (since 50 cases) for this exampl
e.
...
Now we can use this projected Ymax to scale down our cumulative case
s
...
as well as a best case scenario, (such as 10% of the population gets infect
ed). Then you fit a model for both cases respectively.\
The reality will probably fall somewhere between the two mo
dels.
...
That being said, if you are interested in epidemiological modelling, you should consider taking more advanced courses in that
area.
